...
import { Package, RefreshCw, Truck, X, Edit, Trash2 } from "lucide-react";
      ...
      <div className="flex flex-col h-full min-h-0 max-h-full">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden pt-4 min-h-0 max-h-full -mr-4 pr-4 pb-16 lg:pb-6">
          ...
          <EditOrderModal
            ...
            onQuantityDirectChange={handleQuantityDirectChange}
            onAdjustQuantity={adjustQuantity}
            getAvailableStockFor={getAvailableStockFor}
