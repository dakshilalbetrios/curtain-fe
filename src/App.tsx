  ...
  return (
    <Routes>
      ...
      <Route path="/collections" element={
        <PrivateRoute><CollectionList /></PrivateRoute>
      } />
      <Route path="/collections/:id" element={
        <PrivateRoute><CollectionDetail /></PrivateRoute>
      } />
      <Route path="/collections/new" element={
        <PrivateRoute><AddCollection /></PrivateRoute>
      } />
      ...
      <Route path="/orders/:id/manage" element={
        <PrivateRoute><OrderManagement /></PrivateRoute>
      } />
      <Route path="/retailers" element={
        <PrivateRoute><RetailerList /></PrivateRoute>
      } />
      <Route path="/retailers/new" element={
        <PrivateRoute><AddRetailer /></PrivateRoute>
      } />
